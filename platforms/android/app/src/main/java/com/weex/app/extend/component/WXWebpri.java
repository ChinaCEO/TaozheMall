package com.weex.app.extend.component;
...
import com.weex.app.util.WXWebView;
...
public class WXWebpri extends WXComponent {
    ...
    @Deprecated
    public WXWebpri(WXSDKInstance instance, WXVContainer parent, String instanceId, boolean isLazy, BasicComponentData basicComponentData) {
        this(instance, parent, isLazy, basicComponentData);
    }

    public WXWebpri(WXSDKInstance instance, WXVContainer parent, boolean isLazy, BasicComponentData basicComponentData) {
