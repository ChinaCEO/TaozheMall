...
public class AppConfigXmlParser {
  ...
  private com.taozhemall.app.util.AppPreferences prefs = new com.taozhemall.app.util.AppPreferences();

  public com.taozhemall.app.util.AppPreferences getPreferences() {
    return prefs;
  }
